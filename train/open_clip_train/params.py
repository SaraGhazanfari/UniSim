...
def parse_args(args):
    ...
    parser.add_argument(
        "--train-data-name",
        type=str,
        default="night:pie-app:magic_brush:hq_edit:polaris:hpd:kadid:pipal",
    ...
    parser.add_argument(
        "--val-batch-size", type=int, default=400, help="Batch size per GPU."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--val-frequency", type=int, default=1, help="How often (number of steps) to run evaluation with val data."
    )
    parser.add_argument(
        "--resume",
        default=None,
    ...
    parser.add_argument("--reg-wd", type=float, default=100_000, help="Weight for mse loss.")
    parser.add_argument(
        "--distill-model",
        default=None,
    ...
    parser.add_argument(
        ...
        default='BL',
        type=str,
        choices=['CL', 'BL', 'HL'] #CL: Contrastive Loss, BL: Binary Loss, Hinge Loss
    )
    parser.add_argument(
        "--task-weight",
        default='plain',
        type=str,
        choices=['plain', 'acc'] #CL: Contrastive Loss, BL: Binary Loss, Hinge Loss
    )
    ...
    parser.add_argument('--clip-iqa', action='store_true', default=False)
    parser.add_argument('--normalize', action='store_true', default=False)
    parser.add_argument('--check-run', action='store_true', default=False)
